--- 
title: "Shiny app for submission"
...
```
```{r}
#fix issue with submission date
...
print("Historical sightings by selected county"),
br(), 
...
print(trial)
      ...
      v<- c(trial$value[2]/trial$value[3]/trial$value[1])
...
br()
  ...
  output$table <- DT::renderDataTable(DT::datatable({
   ...
   data<- bigfootDated2
    ...
    filter(county == input$a)%>% 
    filter(month == input$b | day == input$c)
