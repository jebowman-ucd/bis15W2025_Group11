...
box(title = "Plot Options", 
          width = 3, #adjust the column width
                ...
                selectInput("a", 
                            "Select County",
                            choices = unique(bigfootDated_Jenn$county), #instead of typing all options, we can use unique()
...
box(title = "Check your chance of seeing bigfoot", width = 6, #adjust the column width and add title
